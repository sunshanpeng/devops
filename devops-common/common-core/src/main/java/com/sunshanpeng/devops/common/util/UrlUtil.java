...
public class UrlUtil {
    private static final String RE_TOP_DOMAIN = "(com\\.cn|com\\.hk|net\\.cn|gov\\.cn|org\\.nz|org\\.cn|com|net|org|gov|cc|biz|info|cn|co|me|vpc)";
    ...
    public static String getRR(String url) {
